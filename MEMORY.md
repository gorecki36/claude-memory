...
- [Writing guard hook](reference_writing_guard_hook.md): Hard-blocks banned writing patterns (em-dash, jargon, banned filler words, stale "just") via Stop + PostToolUse hooks; bypass with the skip token; tune lists in ~/.claude/writing-guard.py
