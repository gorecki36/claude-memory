---
name: feedback-plain-headlines
description: "Slide headlines must be plain and descriptive, never clever; the word \"quiet\" is banned"
metadata: 
  node_type: memory
  type: feedback
  originSessionId: 129a430c-f8dc-4f65-8045-47f16c8f3e25
---
...
**How to apply:** Lead with the factual takeaway in present tense. When framing interpretation, label it ("Hypothesis: …") rather than dressing it up. Keep the data as fact; hedge only the interpretation. See also [[feedback-no-em-dashes]], [[feedback-no-chip-pills]].
